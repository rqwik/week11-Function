...
namespace FunctionsReturn
{
    class Program
    {
        ...
        {
            string[] heroes = { "Captain America", "Iron Man", "Thor", "Hulk", "Captain Marvel", "Black Panther", "Black Widow" };
            string[] villains = { "Thanos", "Ultron", "Malekith", "Mystique", "Loki", "Venom", "Juggernaut" };
        ...
        {
            Random rnd = new Random();
            int randomHP = rnd.Next(0, characterName.Length + 1); //return rnd.Next(0, characterName.Length + 1) если используем так
            return randomHP;                                       //тогда эту строчку комментируем
        }
